            ...
            writer.writerow(
                {
                    ...
                    "source_page_count": lead.source_document_count,
                    "unique_source_domains": "; ".join(lead.source_domains),
    ...
    for lead in top_leads:
        lines.extend(
            [
                ...
                f"- Source pages: {lead.source_document_count}",
                f"- Unique source domains: {', '.join(lead.source_domains) if lead.source_domains else 'none'}",
